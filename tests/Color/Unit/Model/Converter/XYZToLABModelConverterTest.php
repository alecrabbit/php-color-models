...
final class XYZToLABModelConverterTest extends TestCase
{
    #[Test]
    public function returnsCorrectModelTo(): void
    {
        self::assertEquals(new ModelLAB(), XYZToLABModelConverter::to());
    }

    #[Test]
    public function returnsCorrectModelFrom(): void
    {
        self::assertEquals(new ModelXYZ(), XYZToLABModelConverter::from());
    }
    ...
    protected function getTesteeInstance(
        ...
        return new XYZToLABModelConverter(
